...
INSERT INTO regions(id, created_at, updated_at, "provider", database_region, supports_neon_vm) VALUES (1, now(), now(), 'neon.tech', 'aws-us-east-1', 'f');
...
INSERT INTO regions(id, created_at, updated_at, "provider", database_region, supports_neon_vm) VALUES (3, now(), now(), 'neon.tech', 'aws-us-west-2', 'f');
